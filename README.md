...
- `envs/dev/terraform.tfvars` - Fill in your `customer_gateway_ip` and optionally `customer_gateway_asn`

Quick start:
1. Fill `envs/dev/terraform.tfvars` with your public IP, ASN, and Key Pair.
